...
FC2_NPY_PATH = "/Users/bytedance/Desktop/bishe/2_huase_augment/save_int8_new/fc2_weight_int8.npy"
FC3_NPY_PATH = "/Users/bytedance/Desktop/bishe/2_huase_augment/save_int8_new/fc3_weight_int8.npy"
...
if __name__ == '__main__':
    ...
    # 检查文件是否存在
    for file_path in [MODEL_PATH, FC2_NPY_PATH, FC3_NPY_PATH]:
        if not os.path.exists(file_path):
            raise FileNotFoundError(f"文件不存在: {file_path}")
    
    # 加载模型
    model = SNNInferModel(MODEL_PATH, FC2_NPY_PATH, FC3_NPY_PATH, TIME_STEPS).to(DEVICE)
