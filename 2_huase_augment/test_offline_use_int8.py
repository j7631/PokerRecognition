...
FC2_WEIGHT_NPY = '/Users/bytedance/Desktop/bishe/2_huase_augment/save_int8_qat_compatible/fc2_weight_int8.npy'  # INT8 FC2权重
FC3_WEIGHT_NPY = '/Users/bytedance/Desktop/bishe/2_huase_augment/save_int8_qat_compatible/fc3_weight_int8.npy'  # INT8 FC3权重
...
class FloatPart(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(128 * 6 * 6, 512, bias=False)  # 替换为普通Linear（兼容INT8推理）
...
def main():
    # 1. 加载INT8推理模型
    print("===== 加载INT8推理模型 =====")
    model = SNNInferModel(MODEL_PATH, FC2_WEIGHT_NPY, FC3_WEIGHT_NPY)
    print("✅ 模型加载完成")
